...
export default function ColorPicker() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[#bbcd60] dark:bg-gray-900">
      {/* Center the color picker card within the screen */}
      <Card className="w-full max-w-md mx-auto p-8 bg-[#ddea99] grid gap-8">
